...
public:
	...
	virtual void evaluate(const ShadeTreeNodes& tree_nodes, const std::string& output_slot, ShadeTreeEvaluation& evaluation) = 0;
	std::string type;
	std::string name;
...
protected:
	std::string _evaluateInputSlot(const ShadeTreeNodes& tree_nodes, const std::string& slot_name, ShadeTreeEvaluation& evaluation);
};
